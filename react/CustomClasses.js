export default {
  MAIN_CLASS: 'vtex-product-image',
  VERTICAL_COMPONENT: 'vtex-product-image__vertical',
  ...
  HORIZONTAL_ARROW_PREV: 'vtex-product-image__horizontal-arrow--prev',
  HORIZONTAL_ARROW_NEXT: 'vtex-product-image__horizontal-arrow--next',
