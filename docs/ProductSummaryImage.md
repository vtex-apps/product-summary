...
| `loading`         | `string` | The image loading strategy propery (`'eager'`, `'lazy'`, `'auto'`). By default, the VTEX IO determines what type is better, however, it's possible to change it by setting this property
