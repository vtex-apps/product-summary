...
const ProductSummaryListWithQuery = ({ children, ...props }) => {
  const {
    category = '',
    collection,
  ...
  return <ProductSummaryList products={products}>{children}</ProductSummaryList>
}

ProductSummaryListWithQuery.getSchema = () => ({
...
export default ProductSummaryListWithQuery
